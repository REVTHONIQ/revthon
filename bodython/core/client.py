        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
            ...
            if pattern is not None:
                ...
                if edited:
                    bodyiq.add_event_handler(func, events.MessageEdited(**kwargs))
                bodyiq.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            ...
            if edited is True:
                bodyiq.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                bodyiq.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
