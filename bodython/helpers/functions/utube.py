...
PATH = "./bodython/cache/ytsearch.json"
...
async def yt_search(bodython):
    try:
        bodython = urllib.parse.quote(bodython)
        html = urllib.request.urlopen(
            f"https://www.youtube.com/results?search_query={bodython}"
        )
...
"""
async def yt_data(bodython):
    params = {"format": "json", "url": bodython}
