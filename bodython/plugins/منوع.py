...
@bodyiq.on(admin_cmd(pattern="دعوه للمكالمه(?: |$)(.*)"))
async def _(e):
...
@bodyiq.on(admin_cmd(pattern="بدء مكالمه(?: |$)(.*)"))
async def _(e):
    try:
...
R = [
    ...
    "**-** مطور السورس **⪼ [𐇮 𓂐 𓆩الــسيد𓆪 𖠛🇷🇺 ](t.me/JF_61)   \n"
    "**-** قناة السورس **⪼ [𐇮 بوديي ](t.me/bodython)   "
]

@bodyiq.on(admin_cmd(pattern="بلي$"))
...
@bodyiq.on(admin_cmd(pattern="اذكار$"))
async def ithker(knopis):
...
@bodyiq.on(admin_cmd(pattern="كت$"))
async def ithker(knopis):
...
@bodyiq.on(admin_cmd(pattern="خيروك$"))
async def ithker(knopis):
    await knopis.edit(choice(bodython_5erok))

    
@bodyiq.on(admin_cmd(pattern="اذكار عشر$"))    
...
@bodyiq.on(admin_cmd(pattern="شنو رأيك بهذا$"))
async def ithker(knopis):
    await knopis.edit(choice(bodython_Shnow))
...
@bodyiq.on(admin_cmd(pattern="بوسة$"))
async def ithker(knopis):
    await knopis.edit(choice(bodython_Bosa))
