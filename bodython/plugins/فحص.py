...
from bodython import StartTime, bodyiq, bodyVERSION
...
async def amireallyalive(event):
    ...
    ALIVE_TEXT = gvarstatus("ALIVE_TEXT") or "**父[ 𝙹𝙾𝙺𝙴𝚁 𝙸𝚂 𝚆𝙾𝚁𝙺𝙸𝙽𝙶 ✓ ](t.me/bodython)父**"
    RR7_IMG = gvarstatus("ALIVE_PIC") or Config.A_PIC
    bodyiq_caption = gvarstatus("ALIVE_TEMPLATE") or temp
    caption = bodyiq_caption.format(
