...
from . import bodyiq, edit_delete, reply_id
...
@bodyiq.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}لستة قنواتي الرسمية [𝗧ُِٔ𝗢ٍَِ𝗢َِّ𝗟َٖ𝗦َ]<buttonurl:t.me/bodyThon> [𝗝ََِ𝗠ٓ𝗧َُِْٓ𝗛ُ𝗢َ𝗡ٍَ]<buttonurl:t.me/bodyThon> ",
    },
)
async def _(event):
