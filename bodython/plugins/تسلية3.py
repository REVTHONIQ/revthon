...
from . import bodyiq, edit_delete, edit_or_reply, mention
...
async def _(event):
    ...
    animation_chars = [
        ...
        "**Starting process with command** `python3 -m bodython`",
        "**State changed from starting to up**",
        "__INFO:bodython:Logged in as 557667062__",
        "__INFO:bodython:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
