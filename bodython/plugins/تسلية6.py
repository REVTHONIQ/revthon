...
@bodyiq.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}ترامب <text>",
        "examples": "{tr}trump Catuserbot is One of the Popular bodython",
    },
)
...
@bodyiq.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}غير عقلي Catuserbot is One of the Popular bodython",
    },
)
async def nekobot(cat):
    text = cat.pattern_match.group(1)
...
@bodyiq.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}كانا text",
        "examples": "{tr}kanna bodython is One of the Popular bodython",
    },
)
async def nekobot(cat):
...
@bodyiq.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}tweet iamsrk ; bodython is One of the Popular bodython",
    },
)
async def nekobot(cat):
