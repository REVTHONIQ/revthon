...
class Config(object):
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/bodythoniq/bodython.git"
    )
    ...
    TIME_BODY = os.environ.get("TIME_BODY", None)
    ...
    PMPERMIT_TEXT_Bodython = os.environ.get("PMPERMIT_TEXT_Bodython", None)
    UB_BLACK_LIST_CHAT = {
    ...
    # specify NO_LOAD with plugin names for not loading in bodython
