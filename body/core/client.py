        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
            ...
            if pattern is not None:
                ...
                if edited:
                    body.add_event_handler(func, events.MessageEdited(**kwargs))
                body.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            ...
            if edited is True:
                body.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                body.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
