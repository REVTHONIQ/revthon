...
@body.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}ترامب <text>",
        "examples": "{tr}trump  is One of the Popular body",
    },
)
...
@body.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}غير عقلي Catbody is One of the Popular body",
    },
)
async def nekobot(cat):
    text = cat.pattern_match.group(1)
...
@body.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}كانا text",
        "examples": "{tr}kanna  is One of the Popular body",
    },
)
async def nekobot(cat):
...
@body.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}tweet iamsrk ; is One of the Popular body",
    },
)
async def nekobot(cat):
