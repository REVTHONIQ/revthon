...
ROE = """** اهلا بك عزيزي المستخدم في قائمة اوامر بودي
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        query = event.text
        await body.get_me()
        if query.startswith("اوامري") and event.query.user_id == body.uid:
            buttons = [
                [Button.inline("معلومات بودي", data="AOMRDB")],
                [
...
@body.ar_cmd(pattern="اوامري")
async def repo(event):
    start = Config.TG_BOT_USERNAME
    if event.reply_to_msg_id:
        await event.get_reply_message()
    response = await body.inline_query(start, "اوامري")
    await response[0].click(event.chat_id)
    await event.delete()


@body.tgbot.on(CallbackQuery(data=re.compile(rb"MAIN")))
@check_owner
async def _(event):
    butze = [
        [Button.inline("معلومات بودي", data="AOMRDB")],
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"VARJMTHON")))
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"namevar")))
async def varssett(event):
    await event.edit(
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"symnamvar")))
async def varssett(event):
    await event.edit(
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"phovarlok")))
async def varssett(event):
    await event.edit(
        """نوع الفار: فارات البروفايل
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"AOMRDB")))
async def varssett(event):
    await event.edit(
        """اهلا بك في قائمة اوامر سورس بودي هذه بعض المعلومات عن بودي:

- سورس بودي يمتلك اكثر من 100 أمر 
- بودي هو افضل سورس عربي يتميز بالحماية
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"biolokvar")))
async def varssett(event):
    await event.edit(
        """نوع الفار: فارات البروفايل
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"numlokvar")))
async def varssett(event):
    await event.edit(
        """نوع الفار: فارات البروفايل
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"nameprvr")))
async def varssett(event):
    await event.edit(
        """نوع الفار: فارات البروفايل
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"pmvars")))
async def varssett(event):
    await event.edit(
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"banklish")))
async def varssett(event):
    await event.edit(
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"warnvars")))
async def varssett(event):
    await event.edit(
        """نوع الفار: فارات الحماية
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"pmvarkish")))
async def varssett(event):
    await event.edit(
        """نوع الفار: فارات الحماية
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"picpmvar")))
async def varssett(event):
    await event.edit(
        """نوع الفار: فارات الحماية
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"alivevar")))
async def varssett(event):
    await event.edit(
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"picvars")))
async def varssett(event):
    await event.edit(
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"kleshalive")))
async def varssett(event):
    await event.edit(
        """ نوع الفار: فارات الفحص
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"rmzalive")))
async def varssett(event):
    await event.edit(
        """نوع الفار: فارات الفحص
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"EXTRACMD")))
@check_owner
async def _(event):
    butze = [
        [
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"HEMAIREF")))
@check_owner
async def _(event):
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"KTABAFE")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="EXTRACMD")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"EXTRAC7")))
@check_owner
async def _(event):
    butze = [
        [
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"DOWMANLODE4")))
@check_owner
async def _(event):
    butze = [
        [
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"INSTAGRAMCMD")))
@check_owner
async def _(event):
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"YOUTUBECMD")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="DOWMANLODE4")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"YOUTUBECCMD")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="DOWMANLODE4")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVETSM")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="DOWMANLODE4")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVEFDO")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="DOWMANLODE4")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"BENTRSTCMD")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="DOWMANLODE4")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"YIOFDD")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="DOWMANLODE4")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"PICSERACJ")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="DOWMANLODE4")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"PICYEYS")))
@check_owner
async def _(event):
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"AJMTHOEF")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="EXTRAC7")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"JISORO")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="EXTRAC7")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"LTABAMEKF")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="EXTRAC7")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"ITESRAZAN")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="EXTRAC7")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"TOGIDEF")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="EXTRAC7")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"STIKERPIC")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="EXTRAC7")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"VASCHER")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="EXTRAC7")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"TAGE4E")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="EXTRACMD")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"PROFUIECMD")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="EXTRACMD")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"SACAMF")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="EXTRACMD")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"R7ALTIE")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="EXTRACMD")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"SALACMD")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="EXTRACMD")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"DATECMD")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="EXTRACMD")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"COROONA")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="EXTRACMD")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"SAVETECXT")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="EXTRACMD")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVETRG")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="EXTRACMD")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"BOTCMD4")))
@check_owner
async def _(event):
    butze = [
        [
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"ALICVEINLI")))
@check_owner
async def _(event):
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVEAUD")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="BOTCMD4")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVESLB")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="BOTCMD4")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"IMSLEEPF")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="BOTCMD4")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"UPDATE4E")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="BOTCMD4")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"ALICES")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="BOTCMD4")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"ALNTDOS")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="BOTCMD4")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"toolsed1")))
@check_owner
async def _(event):
    buttons = [
        [
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVEMEE")))
@check_owner
async def _(event):
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"ADDMEM7")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="toolsed1")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"TOOLCMD2")))
@check_owner
async def _(event):
    buttons = [
        [
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVEDIII")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="toolsed1")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"ALMKD5D")))
@check_owner
async def _(event):
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"NOAZAJ4")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="TOOLCMD2")]]
...
#
@body.tgbot.on(CallbackQuery(data=re.compile(rb"TELEHTMED")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="TOOLCMD2")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"TKRAR3ADI")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="TOOLCMD2")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"MKRRR5")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="TOOLCMD2")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"FGKHEF8")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="TOOLCMD2")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"SPAM3AAH")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="TOOLCMD2")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"STOPTKRARE")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="TOOLCMD2")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"BROADEV1")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="toolsed1")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"BRWAADV1")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="toolsed1")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"CLIONEACMD")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="toolsed1")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"ALIBACK")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="toolsed1")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"KSHFCMD")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="toolsed1")]]
...
#
@body.tgbot.on(CallbackQuery(data=re.compile(rb"ADDTKLED")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="toolsed1")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"STOPAZAG")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="toolsed1")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"TASLIACMD")))
@check_owner
async def _(event):
    buttons = [
        [
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"TSLEACMD")))
@check_owner
async def _(event):
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"TRFEHCMD")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="TASLIACMD")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"admincmd_s")))
@check_owner
async def _(event):
    buttons = [
        [
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"admin2")))
@check_owner
async def _(event):
    buttons = [
        [
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVETFL")))
@check_owner
async def _(event):
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"admi3")))
@check_owner
async def _(event):
    buttons = [
        [
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"ALMN3CMD")))
@check_owner
async def _(event):
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"ADMSS4")))
@check_owner
async def _(event):
    buttons = [
        [
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"ALTKRARCMD")))
@check_owner
async def _(event):
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"ACCD5SS")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="ADMSS4")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"ALMSHRFE1")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="ADMSS4")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVETRS")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="ADMSS4")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"MELICLW")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="ADMSS4")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"ALLRD5")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="ADMSS4")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"ALLRDSTOP")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="ADMSS4")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"RSTOPRD")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="ADMSS4")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"RDAJFDA")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="ADMSS4")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"UMBLCTR")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admi3")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"LISTBLCK")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admi3")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"A3ALMN3")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admi3")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVEundf")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admi3")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVETRSB")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admi3")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVETSV")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admi3")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVEunTHR")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admi3")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVETHR")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admin2")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVEgma")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admin2")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVEADV")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admin2")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVErfe")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admin2")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVEnzl")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admin2")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVESOR")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admin2")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVEsod")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admin2")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVEtnadmin")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admin2")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVEbin")))
@check_owner
async def _(event):
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVEunbin")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admincmd_s")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVEadmin")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admincmd_s")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"KICKCMD")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admincmd_s")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVEMHA")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admincmd_s")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"bancmd")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admincmd_s")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"unbancmd")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admincmd_s")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVEcatm")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admincmd_s")]]
...
@body.tgbot.on(CallbackQuery(data=re.compile(rb"unmutecmd")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admincmd_s")]]
