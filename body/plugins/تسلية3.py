...
from . import edit_delete, edit_or_reply, body, mention
...
async def _(event):
    ...
    animation_chars = [
        ...
        "**Starting process with command** `python3 -m body`",
        "**State changed from starting to up**",
        "__INFO:body:Logged in as 557667062__",
        "__INFO:body:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
...
@body.on(admin_cmd(pattern="احبك"))
async def rz(body):
    roz = random.choice(love)
    return await edit_or_reply(body, roz)
