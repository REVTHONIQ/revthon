...
from . import edit_delete, edit_or_reply, body, progress
...
@body.ar_cmd(pattern="زايب(?:\s|$)([\s\S]*)")
...
@body.ar_cmd(pattern="ان زايب(?:\s|$)([\s\S]*)")
async def zip_file(event):
...
@body.ar_cmd(pattern="ان تار(?:\s|$)([\s\S]*)")
