...
from body import StartTime, jmthonversion, body
...
async def amireallyalive(event):
    ...
    ALIVE_TEXT = gvarstatus("ALIVE_TEXT") or "**سورس بودي يعمل بنجاح**"
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        query = event.text
        await body.get_me()
        if query.startswith("السورس") and event.query.user_id == body.uid:
            buttons = [
                [
