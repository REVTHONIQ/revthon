...
import body
from body import BOTLOG_CHATID, PM_LOGGER_GROUP_ID
...
try:
    ...
    body.loop.run_until_complete(setup_bot())
...
try:
    ...
    body.loop.run_until_complete(mybot())
...
body.loop.run_until_complete(startup_process())

if len(sys.argv) in {1, 3, 4}:
    with contextlib.suppress(ConnectionError):
        body.run_until_disconnected()
else:
    body.disconnect()
