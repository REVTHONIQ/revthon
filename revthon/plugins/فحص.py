...
from revthon import StartTime, reviq, REVVERSION
...
@reviq.on(admin_cmd(pattern=f"{ALIVE_ET}(?:\s|$)([\s\S]*)"))
...
async def amireallyalive(event):
    ...
    ALIVE_TEXT = gvarstatus("ALIVE_TEXT") or "**父[ 𝙹𝙾𝙺𝙴𝚁 𝙸𝚂 𝚆𝙾𝚁𝙺𝙸𝙽𝙶 ✓ ](t.me/Revthon)父**"
    RR7_IMG = gvarstatus("ALIVE_PIC") or Config.A_PIC
    reviq_caption = gvarstatus("ALIVE_TEMPLATE") or temp
    caption = reviq_caption.format(
