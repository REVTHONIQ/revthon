...
@reviq.on(admin_cmd(pattern="دعوه للمكالمه(?: |$)(.*)"))
async def _(e):
...
@reviq.on(admin_cmd(pattern="بدء مكالمه(?: |$)(.*)"))
async def _(e):
    try:
...
R = [
    ...
    "**-** مطور السورس **⪼ [𐇮 𓂐 𓆩الــسيد𓆪 𖠛🇷🇺 ](t.me/DEVREVV)   \n"
    "**-** قناة السورس **⪼ [𐇮 ريفي ](t.me/Revthon)   "
]

@reviq.on(admin_cmd(pattern="بلي$"))
...
@reviq.on(admin_cmd(pattern="اذكار$"))
async def ithker(knopis):
...
@reviq.on(admin_cmd(pattern="خيروك$"))
async def ithker(knopis):
    await knopis.edit(choice(Revthon_5erok))

    
@reviq.on(admin_cmd(pattern="اذكار عشر$"))    
...
@reviq.on(admin_cmd(pattern="شنو رأيك بهذا$"))
async def ithker(knopis):
    await knopis.edit(choice(Revthon_Shnow))
...
@reviq.on(admin_cmd(pattern="بوسة$"))
async def ithker(knopis):
    await knopis.edit(choice(Revthon_Bosa))
