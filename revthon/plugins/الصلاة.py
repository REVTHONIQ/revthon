#ترجمه فريق ريف على التيلكرام
import json

import requests
#ترجمه فريق ريف على التيلكرام
from ..sql_helper.globals import gvarstatus
from . import reviq, edit_delete, edit_or_reply
...
async def get_adzan(adzan):
    ...
    reviqresult = f"<b>اوقـات صـلاه المـسلمين 👳‍♂️ </b>\
    ...
    "
    await edit_or_reply(adzan, reviqresult, "html")
