...
from . import reviq, edit_delete, edit_or_reply, mention
...
async def _(event):
    ...
    animation_chars = [
        ...
        "**Starting process with command** `python3 -m revthon`",
        "**State changed from starting to up**",
        "__INFO:revthon:Logged in as 557667062__",
        "__INFO:revthon:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
