...
@reviq.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}ترامب <text>",
        "examples": "{tr}trump Catuserbot is One of the Popular revthon",
    },
)
...
@reviq.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}غير عقلي Catuserbot is One of the Popular revthon",
    },
)
async def nekobot(cat):
    text = cat.pattern_match.group(1)
...
@reviq.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}كانا text",
        "examples": "{tr}kanna revthon is One of the Popular revthon",
    },
)
async def nekobot(cat):
...
@reviq.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}tweet iamsrk ; revthon is One of the Popular revthon",
    },
)
async def nekobot(cat):
