...
PATH = "./revthon/cache/ytsearch.json"
...
async def yt_search(revthon):
    try:
        revthon = urllib.parse.quote(revthon)
        html = urllib.request.urlopen(
            f"https://www.youtube.com/results?search_query={revthon}"
        )
...
"""
async def yt_data(revthon):
    params = {"format": "json", "url": revthon}
