        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
            ...
            if pattern is not None:
                ...
                if edited:
                    reviq.add_event_handler(func, events.MessageEdited(**kwargs))
                reviq.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            ...
            if edited is True:
                reviq.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                reviq.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
